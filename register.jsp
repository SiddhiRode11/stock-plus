        ...
        >
          ...
          <div class="input">
            ...
            <input
              ...
              title="Please enter a valid PAN card number (5 uppercase letters, 4 digits, 1 uppercase letter)"
            />
          </div>
          <div class="input">
            ...
            <input
              ...
              required
              pattern="[1-9][0-9]{9}"
              title="Please enter a valid 10-digit phone number without leading zeros"
            />
          </div>
          <div class="input">
          ...
          <div id="dobError" style="color: red; display: none">
          ...
          <label class="textlabel" for="file-upload"
