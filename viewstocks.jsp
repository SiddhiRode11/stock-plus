...
pageEncoding="ISO-8859-1"%> <%@ page import="com.chainsys.tradingapp.model.*" %>
<%@ page import="org.springframework.context.ApplicationContext"%> <%@ page
import="org.springframework.web.context.support.WebApplicationContextUtils"%>
<%@ page import="jakarta.servlet.http.HttpSession"%> <%@ page
import="java.util.*"%> <%@ page import="com.chainsys.tradingapp.model.*"%> <%@
page import="com.chainsys.tradingapp.dao.impl.*"%> <%@ page
import="com.chainsys.tradingapp.dao.*"%> <% if (session == null ||
session.getAttribute("user") == null) { response.sendRedirect("login.jsp");
return; } response.setHeader("Cache-Control", "no-cache, no-store,
must-revalidate"); response.setHeader("Pragma", "no-cache");
response.setHeader("Expires", "0"); ApplicationContext context =
WebApplicationContextUtils.getWebApplicationContext(getServletContext()); User
user = (User) session.getAttribute("user"); StockDAO stockOperations =
(StockDAO) context.getBean("stockImpl"); %>
<!DOCTYPE html>
<html lang="en" data-theme="light" data-pagefind-ignore="all">
  <head>
    ...
    <style>
      ...
      * {
      ...
      :root[data-theme="dark"]
        .stvb-gray[data-astro-cid-xwynydrv].stvb-secondary {
        --stvb-color: #434651;
        --stvb-color-hover: #2a2e39;
      ...
      @media (any-hover: hover) {
        .stvb-primary[data-astro-cid-xwynydrv]:hover,
        .stvb-secondary[data-astro-cid-xwynydrv]:hover {
          color: var(--stvb-color-hover-text);
          background-color: var(--stvb-color-hover);
        }
      }

      .stvb-primary[data-astro-cid-xwynydrv]:active,
      .stvb-secondary[data-astro-cid-xwynydrv]:active {
  ...
  <body>
    ...
    <% int stockid = (int) request.getAttribute("stockid"); Stock stock=
    stockOperations.getStockDetailsById(stockid); String
          ...
          <form action="StockTransaction" method="post">
            ...
            <div class="modal-body">
              <div class="form-group mb-3">
                <label for="stockSymbol" class="font-weight-bold"
                  >Stock Symbol</label
                >
                <input
                  type="text"
              ...
              <div class="form-group mb-3">
                <label for="stockPrice" class="font-weight-bold"
                  >Current Price</label
                >
                <input
                  type="text"
              ...
              <div class="form-group mb-3">
                <label for="totalPrice" class="font-weight-bold"
                  >Total Price</label
                >
                <input
                  type="text"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form action="StockTransaction" method="post">
            ...
            <div class="modal-body">
              <div class="form-group mb-3">
                <label for="sellStockSymbol" class="font-weight-bold"
                  >Stock Symbol</label
                >
                <input
                  type="text"
              ...
              <div class="form-group mb-3">
                <label for="sellStockPrice" class="font-weight-bold"
                  >Current Price</label
                >
                <input
                  type="text"
              ...
              <div class="form-group mb-3">
                <label for="sellQuantity" class="font-weight-bold"
                  >Quantity</label
                >
                <input
                  type="number"
              ...
              <div class="form-group mb-3">
                <label for="sellTotalPrice" class="font-weight-bold"
                  >Total Price</label
                >
                <input
                  type="text"
    ...
    <script>
      ...
      document
        ...
        .addEventListener("input", function () {
          let price =
            parseFloat(document.getElementById("sellStockPrice").value) || 0;
          let quantity = parseInt(this.value) || 1;
