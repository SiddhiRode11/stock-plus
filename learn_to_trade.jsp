...
<body>
   <header>
     <div style="display: flex; justify-content: center; font-size:2px">
           <a href="#" style="color: black;"><div class="logo"><img src="assets/favicon.svg" width="32" height="32" alt="logo"><p style="padding-top:14px"> Stock Plus </p></div>
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
   ...
   <section class="container mt-5">
    <div class="row">
        ...
        <p class="lead">Stock Plus offers free and open stock market and financial education. Learn at your own pace, with interactive and engaging content. Available in multiple languages.</p>
...
<section class="container intro-icons my-5">
  ...
  <div class="row">
      <div class="col-lg-2 col-md-2 col-sm-6 mb-4 mx-2">
          <a class="item" href="#" style="background-color: #77B4F2">
      ...
      <div class="col-lg-2 col-md-3 col-sm-6 mb-4 mx-2">
          <a class="item" href="#" style="background-color: #F0B32A">
