    ...
    <header>
      ...
      <nav class="nav-bar">
        <ul>
          ...
          <li>
            <a href="register.jsp" style="background-color: blue; color: white"
              >Register</a
            >
          </li>
          <% } else{ %>
          <li>
            <a href="/profile" style="background-color: blue; color: white"
              >profile</a
            >
          </li>
          <%} %>
